          ...
          {contactMethods.map((method) => (
            <a 
              ...
              className="
                ...
                gap-3 md:gap-6 
                aspect-square rounded-4xl md:rounded-[3rem] 
                bg-bg-light backdrop-blur-2xl transition-all duration-300
                border-2 border-blue-bold/20 hover:border-blue-bold hover:scale-[1.05] active:scale-95
              "
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-0.5">
                <span className="text-sm md:text-xl font-black text-text-primary">
                  {method.fa}
                </span>
                <span className="text-xs md:text-xs font-bold uppercase tracking-widest opacity-40 group-hover:opacity-100 group-hover:text-blue-bold transition-all">
                  {method.en}
                </span>
              </div>
              ...
              <div className="relative z-10 mt-1 md:mt-2 px-3 py-1 rounded-full bg-bg-primary/50 border border-white/5 group-hover:border-blue-bold/30 transition-all">
                <span className="text-xs md:text-xs font-bold text-text-primary/60 group-hover:text-text-primary uppercase tracking-tighter">
                  {method.value}
                </span>
              </div>
            </a>
