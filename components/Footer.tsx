      ...
      >
        <div className="relative w-full flex items-center text-text-primary overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/2 -translate-y-1/2 h-5 w-px bg-text-secondary left-1/3" />
            <div className="absolute top-1/2 -translate-y-1/2 h-5 w-px bg-text-secondary left-2/3" />
          </div>

          <Link href="/categories" className="w-1/3 text-center py-3 text-sm sm:text-sm md:text-base">
            دسته بندی‌ها
          </Link>

          <Link href="/subscription" className="w-1/3 text-center py-3 text-sm sm:text-sm md:text-base">
            اشتراک
          </Link>

          <Link href="/contact" className="w-1/3 text-center py-3 text-sm sm:text-sm md:text-base">
            راه ارتباطی
          </Link>
        </div>
      </div>
